...
import ProfileSettings from './pages/common/Profile';
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={['airline_manager']} />}>
          <Route path="/manager" element={<DashboardLayout role="manager" />}>
            <Route index element={<RoleIndexRedirect />} />
            <Route path="scheduling" element={<ManageFlights />} />
        ...
        <Route element={<ProtectedRoute allowedRoles={['checkin_staff', 'boarding_staff', 'baggage_staff', 'security_officer', 'maintenance_staff', 'super_admin']} />}>
