...
const NAV = {
  admin: [
    ...
    { label: 'Airlines',       to: '/admin/airlines',       icon: FiGlobe, roles: ['super_admin'] },
    ...
    { label: 'Users',          to: '/admin/users',          icon: FiUser, roles: ['super_admin'] },
    ...
    { label: 'My Profile',     to: '/admin/profile',        icon: FiUser },
  ],
  manager: [
    { label: 'Flight Scheduling', to: '/manager/scheduling',    icon: FiSend },
    { label: 'Notifications',    to: '/manager/notifications', icon: FiBell },
    { label: 'My Profile',       to: '/manager/profile',       icon: FiUser },
  ],
  passenger: [
  ...
  staff: [
    { label: 'Check-in Console', to: '/staff/checkin',     icon: FiCheckSquare, roles: ['checkin_staff', 'super_admin'] },
    { label: 'Boarding Console', to: '/staff/boarding',    icon: FiSend, roles: ['boarding_staff', 'super_admin'] },
    ...
    { label: 'My Profile',       to: '/staff/profile',       icon: FiUser },
  ],
};

const PORTAL_LABELS = {
  admin:     'Admin Portal',
  manager:   'Airline Manager',
...
export default function Sidebar({ role, userRole, isOpen, onClose }) {
  ...
  const links = (NAV[role] ?? []).filter((l) => !l.roles || (userRole && l.roles.includes(userRole)));
